                ...
                {sidebarOptions.map((option) => {
                  ...
                  return (
                    <li key={option.id}>
                      ...
                      > */}
                      <div className="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        {/* fixme: these two span go wrong, fix later */}
